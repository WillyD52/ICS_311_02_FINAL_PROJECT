...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2020 at 01:23 AM
...
('\"Your mind is the scene of the crime.\"', 5, 'English', 'USA', 'Action', 'A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O.');
...
(51, '<img src =\"./images/Inception.jpg\">', 'poster', 5),
(52, '<img src =\"./images/Inception_Still.jpg\">', 'image', 5),
...
(2, 8, 'Lead Actress', ''),
(2, 9, 'Music Composer', ''),
(5, 51, 'Director', 'Chris Nolan'),
(5, 52, 'Producer', 'Emma Thomas'),
(5, 53, 'Music Director', 'Hans Zimmer'),
(5, 54, 'Lead Actor', 'Leonardo DiCaprio'),
(5, 55, 'Lead Actress', 'Ellen Page'),
(5, 56, 'Actor', 'Joseph Gordon-Levitt'),
(5, 57, 'Actress', 'Marion Cotillard'),
(5, 58, 'Lyricist', 'Michel Vaucaire'),
(5, 59, 'Playback Singer', 'Edith Piaf');
...
(5, 51, 'What is the most resilient parasite? Bacteria? A virus? An intestinal worm? An idea. Resilient... highly contagious. Once an idea has taken hold of the brain it\'s almost impossible to eradicate. An idea that is fully formed - fully understood - that sticks; right in there somewhere.');
...
(5, 51, 'Christopher Nolan has said that the snow-based third-level dream was inspired by his favorite James Bond movie On Her Majesty\'s Secret Service .');
...
(50, 'Tracy Sanchez', 'Tracy', 'D', 'Sanchez', 'female', 'tracy.jpg'),
(51, 'Chris Nolan', 'Christopher', 'Jonathan James', 'Nolan', 'male', 'ChrisNolan.jpg'),
(52, 'Emma Thomas', 'Emma ', 'none', 'Thomas Nolan', 'female', 'EmmaThomas.jpg'),
(53, 'Hans Zimmer', 'Hans', 'Florian', 'Zimmer', 'male', 'HansZimmer.jpg'),
(54, 'Leonardo DiCaprio', 'Leonardo', 'Wilhelm', 'DiCaprio', 'male', 'LeonardoDiCaprio.jpg'),
(55, 'Ellen Page', 'Ellen', 'Grace', 'Philpotts-Page', 'female', 'EllenPage.jpg'),
(56, 'Joseph Gordon-Levitt', 'Joseph', 'Leonard', 'Gordon-Levitt', 'male', 'JosephGordonLevitt.jpg'),
(57, 'Marion Cotillard', 'Marion', 'none', 'Cotillard', 'female', 'MarionCotillard.jpg'),
(58, 'Michel Vaucaire', 'Michel', 'none', 'Vaucaire', 'male', 'MichelVaucaire.jpg'),
(59, 'Edith Piaf', 'Edith', 'none', 'Giovanna Gassion', 'female', 'EdithPiaf.jpg');
...
(51, 51, 'According to cinematographer Wally Pfister, Warner Brothers executives approached Christopher Nolan about making this movie in 3-D, but he refused the idea, claiming \"it will distract the storytelling experience of Inception.\"'),
(52, 52, 'Emma Thomas said that \"the work [DiCaprio] did on his character with Chris made the movie less of a puzzle and more of a story of a character audiences could relate to.\"'),
(53, 53, 'After Cotillard was cast, Nolan intended to change the song \"Non, je ne regrette rien\" to eliminate speculation on Marion Cotillard played Piaf in La Vie En Rose (2007), but composer Hans Zimmer persuaded him to keep it. The theme music for this movie, composed by Hans Zimmer, is named \"Time\".'),
(54, 54, 'Leonardo DiCaprio was director Christopher Nolan\'s and producer Emma Thomas\' only choice for the role of Cobb.'),
(55, 55, 'Ellen Page had started as a regular on the series Pit Pony (1999).'),
(56, 56, 'Joseph Gordon-Levitt performed all but one of his own stunts during the fight scene in the spinning hallway.'),
(57, 57, 'Marion Cotillard played Piaf in La Vie En Rose (2007).'),
(58, 58, '\"Non, je ne regrette rien\", meaning \"No, I do not regret anything\", is a French song composed by Charles Dumont, with lyrics by Michel Vaucaire.'),
(59, 59, 'Édith Piaf\'s song \"Non, je ne regrette rien\" is used as a plot device.');
...
(51, 'Non, je ne Regrette ', 'Non! Rien de rien ...\nNon! Je ne regrette rien\nNi le bien qu\'on m\'a fait\nNi le mal tout ça m\'est bien égal!\nNon! Rien de rien ...\nNon! Je ne regrette rien...\nC\'est payé, balayé, oublié\nJe me fous du passé!\nAvec mes souvenirs\nJ\'ai allumé le feu\nMes chagrins, mes plaisirs\nJe n\'ai plus besoin d\'eux!\nBalayés les amours\nAvec leurs trémolos\nBalayés pour toujours\nJe repars à zéro ...\nNon! Rien de rien ...\nNon! Je ne regrette… ', '');
...
(51, 'https://www.youtube.com/watch?v=Q3Kvu6Kgp88', 'audio', 51);
...
(51, 51, 'Director Christopher Nolan cleverly made the movie exactly two hours and twenty-eight minutes long for a reason, the song continually played to wake people up \"from the dream\" is two minutes and twenty-eight seconds.');
