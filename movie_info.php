...
<div class="right-content">
  <div class="container">
    ...
    $sql_B1 = "SELECT first_name, middle_name, last_name, screen_name, role, gender, image_name 
    FROM movie_people
    left join people
...
<div class="right-content">
  <div class="container">
    ...
    //TODO: 
    // query string for the Query A.1
    $sql_C1 = "SELECT title, lyrics, screen_name, role, keyword, s_link, s_link_type
    FROM songs
    ...
    left join people
    on people.id = song_people.people_id
    WHERE movie_id =" . $movie_id;
