...
$sql = "SELECT * from movie_song left join songs on movie_song.song_id = songs.song_id left join movies on movies.movie_id = movie_song.movie_id";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo '<tr>
                                ...
                                <td>'.$row["title"].'</td>
                                <td>'.substr($row["lyrics"],0,30).' </span> </td>
                            </tr>';
                    }//end while
                }//end if
                else {
